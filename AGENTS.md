...
Create videos using AI paired with Codex / Codex
...
Each workflow has its own approach for this — read the workflow's `AGENTS.md`. If a workflow is silent on consistency, you still need to do it; silence doesn't mean optional.
